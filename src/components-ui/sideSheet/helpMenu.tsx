    ...
    return (
        ...
        >
            ...
            >
                <h3>AR Help Guide</h3>
                <p>
                    Welcome to the <strong>Augmented Reality experience on <a href="https://adhocracy.plus/" target="_blank" rel="noopener noreferrer">Adhocracy.plus</a>!</strong><br />Here's how to explore and participate using AR:
                </p>
