...
class GeolocationObject {
    ...
    placeAtWorldCoords(initialCoords: GeolocationCoordinates, initialPosition: Position,
        ...
        // let heading = this.toWorldHeading(this.headingDegrees, compassHeading);
        // const headingDegrees = this.smoothlyUpdateHeading(heading);
        // const rotation = new Rotation(0, THREE.MathUtils.degToRad(headingDegrees), 0);
